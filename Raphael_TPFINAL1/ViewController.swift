...
class ViewController: UIViewController {
    @IBOutlet weak var tempLabel: UILabel!  // ici c'est la connexion avec le label "BONNE CHANCE"
    //---Ici sont les connexions avec les images dos des cartes
    ...
    //---Ici sont les connexions avec le labels "GARDER"
    ...
    //---
    @IBOutlet weak var dealButton: UIButton!  //ici c'est la connexion avec le bouton "DISTRIBUER"
    ...
    //----------------------//----------------------
    @IBAction func cardsToHold(_ sender: UIButton) { //ça s'en va au differents boutons dans les cartes pous savoir quelles cartes on garde pas
        //---
    ...
    //----------------------//----------------------
    @IBAction func betButtons(_ sender: UIButton) {  //ici c'est la connexion avec le boutons "MISER25", "MISER100" et "MISER TOUT"
        //---
        if chances <= 1 {
            return
        }
